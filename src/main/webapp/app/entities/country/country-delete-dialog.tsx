...
export const CountryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationMonoApp.country.delete.question">
        <Translate contentKey="jhipsterSampleApplicationMonoApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
