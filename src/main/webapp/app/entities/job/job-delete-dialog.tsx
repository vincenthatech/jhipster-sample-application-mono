...
export const JobDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationMonoApp.job.delete.question">
        <Translate contentKey="jhipsterSampleApplicationMonoApp.job.delete.question" interpolate={{ id: jobEntity.id }}>
