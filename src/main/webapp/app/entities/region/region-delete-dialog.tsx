...
export const RegionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationMonoApp.region.delete.question">
        <Translate contentKey="jhipsterSampleApplicationMonoApp.region.delete.question" interpolate={{ id: regionEntity.id }}>
