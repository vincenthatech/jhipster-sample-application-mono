...
export const LocationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationMonoApp.location.delete.question">
        <Translate contentKey="jhipsterSampleApplicationMonoApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
