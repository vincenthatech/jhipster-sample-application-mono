...
export const EmployeeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationMonoApp.employee.delete.question">
        <Translate contentKey="jhipsterSampleApplicationMonoApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
