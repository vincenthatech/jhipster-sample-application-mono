  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplicationMonoApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplicationMonoApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplicationMonoApp.employee.firstName')}
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplicationMonoApp.employee.lastName')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationMonoApp.employee.email')}
                id="employee-email"
                name="email"
                data-cy="email"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationMonoApp.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationMonoApp.employee.hireDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationMonoApp.employee.salary')}
                id="employee-salary"
                name="salary"
                data-cy="salary"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationMonoApp.employee.commissionPct')}
              ...
              <ValidatedField
                ...
                name="manager"
                data-cy="manager"
                label={translate('jhipsterSampleApplicationMonoApp.employee.manager')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('jhipsterSampleApplicationMonoApp.employee.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
