  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplicationMonoApp.jobHistory.home.createOrEditLabel" data-cy="JobHistoryCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplicationMonoApp.jobHistory.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplicationMonoApp.jobHistory.startDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationMonoApp.jobHistory.endDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationMonoApp.jobHistory.language')}
              ...
              >
                {languageValues.map(language => (
                  <option value={language} key={language}>
                    {translate(`jhipsterSampleApplicationMonoApp.Language.${language}`)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                ...
                name="job"
                data-cy="job"
                label={translate('jhipsterSampleApplicationMonoApp.jobHistory.job')}
                type="select"
              >
                <option value="" key="0" />
                {jobs
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('jhipsterSampleApplicationMonoApp.jobHistory.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('jhipsterSampleApplicationMonoApp.jobHistory.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
