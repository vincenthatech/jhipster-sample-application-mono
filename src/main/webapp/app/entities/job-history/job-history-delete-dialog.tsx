...
export const JobHistoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationMonoApp.jobHistory.delete.question">
        <Translate contentKey="jhipsterSampleApplicationMonoApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
