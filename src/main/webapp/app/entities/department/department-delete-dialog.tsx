...
export const DepartmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationMonoApp.department.delete.question">
        <Translate contentKey="jhipsterSampleApplicationMonoApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
